...
<style lang="scss">
    ...
    .template {
        ...
        .user-img {
            ...
            border: solid rpx(5) rgba($gray, .1);
            @include imgauto;
            z-index: 15;
